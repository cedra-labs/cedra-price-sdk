...
#[test_only]
module pyth::external_address_test {
    use pyth::external_address::{get_bytes, left_pad, from_bytes, pad_left_32};
    ...
    #[test]
    #[expected_failure(abort_code = 0, location = pyth::external_address)]
